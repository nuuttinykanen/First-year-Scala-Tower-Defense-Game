...
object test extends App {
  ...
  println(s"Wave enemy list: ${game.getWave.getEnemyList}")
  ...
  println(s"Enemies present: ${map.getEnemySquares.map(_.getEnemy)}")
  println(s"Their locations: ${map.getEnemySquares.map(_.x).zip(map.getEnemySquares.map(_.y))}")
  println(s"Wave list: ${game.getWave.getEnemyList.mkString}")
  game.passTime()
  game.passTime()
  game.passTime()
  game.passTime()
  game.passTime()
  game.passTime()
  println(s"END Wave list: ${game.getWave.getEnemyList.mkString}")
  println(s"${map.getEnemySquares.map(_.getEnemy)}")
