...
class Simon extends AttackRecruit("Simon Belmont", "", 10, 1, 2, 5, None)

class VanHelsing extends AttackRecruit("Van Helsing", "", 30, 2, 1, 5, None)

class Ash extends AttackRecruit("Ash", "", 10, 5, 4, 8, Some(new ChainsawAsh))

class ChainsawAsh extends AttackRecruit("Ash with Chainsaw", "", 3, 4, 1, 16, None)
